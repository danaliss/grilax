...
INSERT INTO event (event_name, event_date, event_time, description, deadline, menu_id, address_id)
VALUES ('Christmas Cookout', '12-20-2019', '3pm', 'A fun get together for Christmas!', '12-10-2019', '1', '1');

INSERT INTO menu (event_id) VALUES ('1');

INSERT INTO food (food_name, vegetarian, vegan, gluten_free, nut_free, description, menu_id)
